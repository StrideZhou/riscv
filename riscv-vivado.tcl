...
#
# riscv-vivado.tcl: Tcl script for re-creating project 'riscv'
#
# Generated by Vivado on Wed Jun 16 22:57:17 +0800 2021
...
#
# 1. This project restoration tcl script (riscv-vivado.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/MyCode/riscv/alu.vh"
#    "C:/MyCode/riscv/alu.v"
#    "C:/MyCode/riscv/opcode.vh"
#    "C:/MyCode/riscv/alu_mod.v"
#    "C:/MyCode/riscv/mem.vh"
#    "C:/MyCode/riscv/dmem_mod.v"
#    "C:/MyCode/riscv/ins_mod.v"
#    "C:/MyCode/riscv/inst_decoder.v"
#    "C:/MyCode/riscv/mem.v"
#    "C:/MyCode/riscv/memory.v"
#    "C:/MyCode/riscv/regFile.v"
#    "C:/MyCode/riscv/syn_reg.v"
#    "C:/MyCode/riscv/core.v"
#    "C:/MyCode/riscv/riscv-imem.mem"
#    "C:/MyCode/riscv/riscv.srcs/constrs_1/new/cons.xdc"
#    "C:/MyCode/riscv/core_tb.sv"
#    "C:/MyCode/riscv/riscv.sim/sim_1/behav/xsim/xsim.dir/test_behav/test_behav.wcfg"
#
...
set script_file "riscv-vivado.tcl"
...
set files [list \
 [file normalize "${origin_dir}/alu.vh" ]\
 [file normalize "${origin_dir}/alu.v" ]\
 [file normalize "${origin_dir}/opcode.vh" ]\
 [file normalize "${origin_dir}/alu_mod.v" ]\
 [file normalize "${origin_dir}/mem.vh" ]\
 [file normalize "${origin_dir}/dmem_mod.v" ]\
 [file normalize "${origin_dir}/ins_mod.v" ]\
 [file normalize "${origin_dir}/inst_decoder.v" ]\
 [file normalize "${origin_dir}/mem.v" ]\
 [file normalize "${origin_dir}/memory.v" ]\
 [file normalize "${origin_dir}/regFile.v" ]\
 [file normalize "${origin_dir}/syn_reg.v" ]\
 [file normalize "${origin_dir}/core.v" ]\
 [file normalize "${origin_dir}/riscv-imem.mem" ]\
]
...
set file "[file normalize "$origin_dir/riscv.srcs/constrs_1/new/cons.xdc"]"
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/core_tb.sv" ]\
 [file normalize "${origin_dir}/riscv.sim/sim_1/behav/xsim/xsim.dir/test_behav/test_behav.wcfg" ]\
]
...
set file "test_behav/test_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
if {[string equal [get_runs -quiet synth_2] ""]} {
    create_run -name synth_2 -part xc7z010clg400-1 -flow {Vivado Synthesis 2019} -strategy "Flow_AreaOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7z010clg400-1 -flow {Vivado Implementation 2019} -strategy "Area_ExploreWithRemap" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2
} else {
  set_property strategy "Area_ExploreWithRemap" [get_runs impl_2]
...
set_property -name "steps.post_place_power_opt_design.is_enabled" -value "1" -objects $obj
